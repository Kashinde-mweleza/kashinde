...
<head>
    ...
    <style>
        body { background-color: gray; font-family: Arial, sans-serif; color: white; padding: 20px; }
        .center-box { display: flex; justify-content: center; align-items: center; margin-top: 60px; }
